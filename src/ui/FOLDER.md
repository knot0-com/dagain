...
It serves a local HTML dashboard (chat + DAG + node logs + sessions browser) plus JSON/SSE endpoints.
It also exposes a small local control API (start/pause/resume/replan/set-workers/cancel), plus log/chat/runs/sessions APIs.
